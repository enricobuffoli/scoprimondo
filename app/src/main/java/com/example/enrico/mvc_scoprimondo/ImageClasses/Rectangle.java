package com.example.enrico.mvc_scoprimondo.ImageClasses;
...
public class Rectangle
{
    ...
    private int returnScaleSign()
    {
        if(totScaleX*partScaleX<0)
            return -1;
        else
            return 1;
    }
	...
	{
		A.x=(float)this.returnScaleSign()*(float)Math.cos(rectAngle-rotationAngle)*((float)Math.sqrt(Math.pow((width*(totScaleX*partScaleX))/2,2)+Math.pow((height*(totScaleY*partScaleY))/2,2)));
		...
		B.x=(float)this.returnScaleSign()*(float)Math.cos(rectAngle+ABAngle-rotationAngle)*((float)Math.sqrt(Math.pow((width*(totScaleX*partScaleX))/2,2)+Math.pow((height*(totScaleY*partScaleY))/2,2)));
		...
		C.x=(float)this.returnScaleSign()*(float)Math.cos(Math.PI+rectAngle-rotationAngle)*((float)Math.sqrt(Math.pow((width*(totScaleX*partScaleX))/2,2)+Math.pow((height*(totScaleY*partScaleY))/2,2)));
		...
		D.x=(float)this.returnScaleSign()*(float)Math.cos(Math.PI+rectAngle+ABAngle-rotationAngle)*((float)Math.sqrt(Math.pow((width*(totScaleX*partScaleX))/2,2)+Math.pow((height*(totScaleY*partScaleY))/2,2)));
